...
result='It exists'
if content_ratings['17+'] in content_ratings:
...
for freq in content_ratings:
    proportion=content_ratings[freq]/total_number_of_apps
    percentage=proportion*100  
    c_ratings_percentages[freq]=percentage
    c_ratings_proportions[freq]=proportion
...
min_size=float(min(data_sizes))
max_size=float(max(data_sizes))